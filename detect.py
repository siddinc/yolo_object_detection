...
arguments = {"input": "C:\\Users\\Siddharth\\yolo_object_detection\\videos\\trim_version.mp4",
             "output": "C:\\Users\\Siddharth\\yolo_object_detection\\output\\output.mp4",
             "yolo": "C:\\Users\\Siddharth\\yolo_object_detection\\yolo-coco",
             "confidence": 0.5,
             "threshold": 0.3,
             }
...
while True:
    ...
    if not grabbed:
        break #break if we reached the end of the frame
